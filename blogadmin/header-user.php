              ...
              <ul class="dropdown-menu">
                ...
                <li class="message-preview">
                  <a href="#">
                    ...
                    <span class="message">Hey ,how you doin' ??</span>
                    <span class="time"><i class="fa fa-clock-o"></i> 1:04 AM</span>
                  </a>
                </li>
                <li class="divider"></li>
                <li class="message-preview">
                  <a href="#">
                    <span class="avatar"><img src="http://placehold.it/50x50"></span>
                    <span class="name">Mohan :</span>
                    <span class="message">Hey, I want to ask you something...</span>
                ...
                <li class="message-preview">
                  <a href="#">
                    ...
                    <span class="message">Can we collab ??</span>
                    <span class="time"><i class="fa fa-clock-o"></i> 4:00 PM</span>
                  </a>
                </li>
                <li class="divider"></li>
